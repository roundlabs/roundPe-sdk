...
// Testing
const data = {
  id: '27a8f790-xxxx-xxxx-xxxx-925d82064495',
  apiVersion: 1,
  createdAt: 'Tue Jul 26 2022 10:45:18 GMT+0000 (Coordinated Universal Time)',
  type: 'charge:completed',
  data: {
    pricingType: 'fixed_price',
    code: 'XXXXXXXXXX',
    name: 'Test Payment',
    supportedNetworks: ['flow', 'bsc'],
    supportedTokens: {
      flow: ['flow', 'fusd'],
      bsc: ['busd', 'tether', 'usd-coin'],
    },
    description: '',
    expiresAt: 'Tue Jul 26 2022 10:45:00 GMT+0000 (Coordinated Universal Time)',
    timeline: [
      {
        time: 'Tue Jul 26 2022 11:39:56 GMT+0000 (Coordinated Universal Time)',
        status: 'NEW',
      },
      {
        time: 'Tue Jul 26 2022 11:41:28 GMT+0000 (Coordinated Universal Time)',
        status: 'PENDING',
        txHash:
          '73941db881a876149d3c8d91b852ecfa3c9608854fa41c80869debedfebbdafb',
      },
      {
        time: 'Tue Jul 26 2022 11:41:28 GMT+0000 (Coordinated Universal Time)',
        status: 'COMPLETED',
    ...
    pricing: {
      local: { amount: 2, currency: 'USD' },
      flow: { amount: '1.263', currency: 'flow', exchangeRate: 1.584 },
      fusd: { amount: '2.00', currency: 'fusd', exchangeRate: 0.998 },
      'usd-coin': { amount: '2.00', currency: 'usd-coin', exchangeRate: 0.998 },
      busd: { amount: '2.00', currency: 'busd', exchangeRate: 0.998 },
      tether: { amount: '2.00', currency: 'tether', exchangeRate: 0.9979 },
      dai: { amount: '2.00', currency: 'dai', exchangeRate: 0.998 },
    },
    payments: [
      {
        network: 'flow',
        ...
        value: {
          ...
          local: { amount: 2, currency: 'USD', finalAmount: 1.8, fees: 0.2 },
        },
        block: {
          blockNumber: 74642165,
          requiredConfirmations: 1,
          accumulatedConfirmations: 0,
        },
      },
    ],
    createdAt: '2022-07-26T10:40:05.318Z',
  },
};
